...
| -- | -- | -- | -- |
| **Intro to Node & NPM** | [Intro to Full Stack Development](./week-1/d1-intro-full-stack/1.1-intro-fullstack-http.md)<br>---<br>[Intro to Node](./Unit_2/1-intro-full-stack/1.2-intro-to-node.md) | [Server-side Debugging Setup](./Unit_2/1-intro-full-stack/1.3-server-side-debugging-setup.md) |  | 
