...
- Remove everyhting in between the `div` with a class of `App`
- Change the `div` to a `main`
- Remove the count state
- Remove the import of `reactLogo`, `viteLogo`, and the `useState`.
